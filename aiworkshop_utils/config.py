...
OMODEL_BGE = "bge-m3:latest"
OMODEL_SNOWFLAKE = "snowflake-arctic-embed:latest" # 768 Dimensionen
...
# PATHS:
ASSETS_PATH = '/Users/julian/Documents/Projects/Fachhochschule/aiworkshop/notebooks/assets/'
# --------------------